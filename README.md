...
* PHP 8.2 (Servidor Apache integrado)
...
Nota: O banco de dados `playpark` será criado automaticamente na primeira execução, com as credenciais já predefinidas no arquivo `docker-compose.yml`.

## Estrutura de Diretórios

* `/src` - Contém todo o código-fonte da aplicação (PHP, HTML, CSS, JS).
